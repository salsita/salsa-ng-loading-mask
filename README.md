# salsa-ng-loading-mask [![Build Status](https://travis-ci.org/salsita/salsa-ng-loading-mask.svg?branch=master)](https://travis-ci.org/tomkis1/salsa-ng-loading-mask)
